...
const Chapter3: React.FC = () => {
  ...
  const [cardImages, setCardImages] = useState([
    { id: 1, name: 'Spectral Portrait', image: '/projects/blackwood-mansion/assets/images/ch3.png', audio: 'Scan QR to update' },
    { id: 2, name: 'Witch\'s Grimoire', image: '/projects/blackwood-mansion/assets/images/ch3.png', audio: 'Scan QR to update' },
    { id: 3, name: 'Cursed Pocket Watch', image: '/projects/blackwood-mansion/assets/images/ch3.png', audio: 'Scan QR to update' },
    { id: 4, name: 'Haunted Violin', image: '/projects/blackwood-mansion/assets/images/ch3.png', audio: 'Scan QR to update' },
    { id: 5, name: 'Demon\'s Contract', image: '/projects/blackwood-mansion/assets/images/ch3.png', audio: 'Scan QR to update' },
    { id: 6, name: 'Ghostly Handkerchief', image: '/projects/blackwood-mansion/assets/images/ch3.png', audio: 'Scan QR to update' },
    { id: 7, name: 'Necromancer\'s Ring', image: '/projects/blackwood-mansion/assets/images/ch3.png', audio: 'Scan QR to update' },
    { id: 8, name: 'Shadow Puppet', image: '/projects/blackwood-mansion/assets/images/ch3.png', audio: 'Scan QR to update' },
  ]);
  ...
  // Blood spatter and ghost effects
  useEffect(() => {
  ...
  const goToChapter4 = () => handleScreen('chapter_4');
  ...
  return (
    <SplashContainer>
      <HorrorOverlay>
        ...
        <HorrorTitle>The Blackwood Mansion - Chapter 3</HorrorTitle>

        <TypeAnimation
          sequence={[
            "The detective's hand hovered over the cursed journal, but the sudden sound of footsteps froze him. Hooded figures emerged from the shadows with glowing eyes...",
            1000,
          ]}
          speed={50}
          style={{
        ...
        <div style={{ 
          ...
          <HorrorButton onClick={goToChapter4}>
            Enter Chapter 4
          </HorrorButton>
        </div>
              ...
              onScan={async (data: string | null) => {
                if (data) {
                  ...
                  try {
                    ...
                    // Play the audio from the scanned data
                    if (json.audio) {
